<?php 
$display = get_field('callout_section_display'); // checkbox 
$content = get_field('callout_section_overlay_content'); // wysiwig 
$background_image = get_field('callout_section_background_image'); // image ID 
$background_color = get_field('callout_section_background_color'); // image ID 
$featured_image = get_field('callout_section_featured_image'); // image ID 
$link = get_field('callout_section_button');
if( $link ): 
    $link_url = $link['url'];
